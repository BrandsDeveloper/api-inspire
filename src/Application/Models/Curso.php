    ...
    public function getCursoAll(Request $req, Response $res, $args){
        ...
        $curso = self::join('modulos', 'modulos.curso_id', '=', 'cursos.id')
            ...
            ->select(
                ...
                'curso.slug as curso_slug' ,
                'curso.resumo as curso_resumo' ,
                'curso.descricao as curso_descricao' ,
                'curso.url_capa as curso_url_capa' ,
                'curso.url_destaque as curso_url_destaque' ,
